...
void ChassisInit()
{
    ...
    Motor_Init_Config_s chassis_motor_config = HeroChassisMotorConfig(HERO_CHASSIS_LF_ID, MOTOR_DIRECTION_NORMAL);
    motor_lf = PowerControlInit(&chassis_motor_config);

    chassis_motor_config = HeroChassisMotorConfig(HERO_CHASSIS_RF_ID, MOTOR_DIRECTION_NORMAL);
    motor_rf = PowerControlInit(&chassis_motor_config);

    chassis_motor_config = HeroChassisMotorConfig(HERO_CHASSIS_LB_ID, MOTOR_DIRECTION_NORMAL);
    motor_lb = PowerControlInit(&chassis_motor_config);

    chassis_motor_config = HeroChassisMotorConfig(HERO_CHASSIS_RB_ID, MOTOR_DIRECTION_NORMAL);
    motor_rb = PowerControlInit(&chassis_motor_config);
#elif defined(ROBOT_SENTRY)
    Motor_Init_Config_s chassis_motor_config = SentryChassisMotorConfig(SENTRY_CHASSIS_LF_ID, MOTOR_DIRECTION_NORMAL);
    motor_lf = PowerControlInit(&chassis_motor_config);

    chassis_motor_config = SentryChassisMotorConfig(SENTRY_CHASSIS_RF_ID, MOTOR_DIRECTION_NORMAL);
    motor_rf = PowerControlInit(&chassis_motor_config);

    chassis_motor_config = SentryChassisMotorConfig(SENTRY_CHASSIS_LB_ID, MOTOR_DIRECTION_NORMAL);
    motor_lb = PowerControlInit(&chassis_motor_config);

    chassis_motor_config = SentryChassisMotorConfig(SENTRY_CHASSIS_RB_ID, MOTOR_DIRECTION_NORMAL);
    motor_rb = PowerControlInit(&chassis_motor_config);
#endif
